...
void imprime(char matriz[13][13]){
    ...
    printf("18. Animal criado geralmente em rebanhos (plural) (7)\n");
    printf("22. Pronome (4)\n");
    ...
    printf("04. Pele e um dos _ do futebol brasileiro. (8)\n");
    printf("05. Personagem do Sitio do Pica-pau Amarelo. (4)\n");
    printf("06. Peixe. (7)\n");
    printf("07. Remedio. (5)\n");
    printf("12. Glorificacao. (plural) (8)\n");
    printf("14. Tornar irmao. (7)\n");
    printf("15. Raca de gatos. (7)\n");
